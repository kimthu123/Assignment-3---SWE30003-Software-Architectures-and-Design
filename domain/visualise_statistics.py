"""Provides analytical and statistical visualization logic for sales data."""
...
class VisualiseStatistics:
    """Generates statistics about product sales and revenue."""

    def __init__(self):
        """Initialize statistics with orders and product repository."""
        self.orders = read_json('data/orders.json')
        self.product_repo = ProductRepository()

    def get_mode(self):
        """Return the most frequently purchased product."""
        ...
        return {
            "product_name": (
                product['name'] if product else f"Product ID {most_bought_id}"
            ),
    ...
    def get_average_revenue(self):
        """Calculate average monthly revenue based on order totals."""
    ...
    def get_average_quantity(self):
        """Compute the average quantity purchased per product."""
    ...
    def get_all_stats(self):
        """Return a summary of all calculated statistics."""
        return {
